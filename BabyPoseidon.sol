...
contract BabyToken is ERC20Interface, SafeMath, Ownable {
    ...
    constructor() public {
        ...
        name = "BabyPoseidon";
        decimals = 18;
        _totalSupply = safeMul(1000000000000000, 1000000000000000000); //1,000,000,000,000,000
        Owner = msg.sender;
    ...
    function withdrawToken(address _tokenContract, uint256 amount) public {
